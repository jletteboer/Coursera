...
# Add density of the averages of samples
lines(density(mean_exps))
# Add normal curve
lines(xfit, yfit, lwd=1.5, pch=22, col="red", lty=5)
# Add theoretical center of distribution
abline(v=theo_mean, lwd=1.5, pch=22, col="red", lty=5)
# Add legend
